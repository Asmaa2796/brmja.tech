        ...
        <div className="container">
          ...
          <div className="p-5 bg-white rounded-4 my-3 shadow-sm">
            ...
            >
              ...
              وأفضل الحلول المتقدمة في مجاالت تقنية المعلومات، لنساعدك على بناء
              وتعزيز الوجود الرقمي لعملك عبر اإلنترنت.
            </p>
            <p
              className="line-height fw-bold my-2"
              data-aos="fade-up"
              data-aos-delay="80"
            >
              نؤمن بأن التحول الرقمي هو مفتاح النجاح في عالم األعمال الحديث، لذا
            ...
            <p
              ...
              data-aos-delay="80"
            >
              من تصميم وتجربة المستخدم إلى تطوير األنظمة وإدارة المشاريع، نضع
